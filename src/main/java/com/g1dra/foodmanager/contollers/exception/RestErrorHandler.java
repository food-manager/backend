...
public class RestErrorHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        return buildResponseEntity(new ApiErrorDTO(HttpStatus.UNSUPPORTED_MEDIA_TYPE, builder.substring(0, builder.length() - 2), ex));
    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotWritable(HttpMessageNotWritableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return buildResponseEntity(new ApiErrorDTO(HttpStatus.INTERNAL_SERVER_ERROR, error, ex));
    }
